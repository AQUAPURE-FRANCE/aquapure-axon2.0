...
function getCurrentProductOnHomepage() {
    const currentProductScript = document.getElementById('current-script');
...
var PriceTable = function (options)
{
    if (document.getElementById('current-script').dataset.controller === 'index') {
        ...
        console.log('RANDOM ID PROD -> ' + options.randomMainProductId);
    }
