...
function getCurrentProductOnHomepage(controller = null) {
    ...
    const currentProductScript = document.querySelector('#current-script[data-controller="' + controller + '"]');
...
{
    if (document.getElementById('current-script').dataset.controller === 'index') {
...
// 		function CollapseIndexAcc(element = null) {			
// 			if (document.querySelector('body#index')){
// 	            console.log('Index')
// 	            if(localStorage.getItem('material-icons')) {
// 		            console.log('item Stored')
// 		           if(localStorage.getItem('material-icons') === element.attr('class')) {
// 			           console.log('item = element')
// 			           return false
// 		           } else {
// 			           localStorage.setItem('material-icons', element.attr('class'))
// 			           element = document.querySelector('.' + element.attr('class'))
// 			           console.log('clear')
// 			           localStorage.clear()
// 			           return CollapseIndexAcc(element)
// 		           }
// 		           
// 	            } else {
...
// 		}
    ...
    this._updateAccessoryPrice = function (product)
    {
        ...
        // Update Accessories Group Total Price
        var groupTotalPrice = 0;
        $.each(this.accessories, function (randomid, product)
        {
            var productPrice = 0;
            $.each(product.combinations, function (idProductAttribute, combination) {
                if (typeof combination !== 'undefined' && (parseInt(product.default_id_product_attribute) === parseInt(idProductAttribute) || idProductAttribute == 0) && $(this._selectors.accessoriesCustomQuantity).val()) {
                    productPrice = product.qty * combination.price;
                }
                if (!$.isEmptyObject(combination.specific_prices))
                {
            ...
            groupTotalPrice += productPrice;
        });


        var groupTotals = groupTotalPrice;
        $('.option-row span.group_total').html(PriceTable.instance._hsmaFormatCurrency(groupTotals));
