        ...
        <div class="promo-code" id="promo-code">
          {block name='cart_voucher_form'}
            <form action="{$urls.pages.cart}" data-link-action="add-voucher" method="post">
              ...
              <input class="promo-input" type="text" name="discount_name" placeholder="{l s='Have a promo code?' d='Shop.Theme.Checkout'}">
          ...
          {block name='cart_voucher_notifications'}
            <div class="alert alert-danger js-error" role="alert">
              <i class="zmdi zmdi-alert-circle-o"></i><span class="ml-1 js-error-text"></span>
            </div>
          {/block}
        </div>
