		...
		<div class="col-lg-6 col-xs-12">
            <div class="row">
				<div class="col-xs-4 text-sm-center text-xs-left">
					<h3 class="card-title h5 _desktop-title hidden-md-down">{l s='Unit price' d='Shop.Theme.Checkout'}</h3>
				</div>
				<div class="col-xs-4 text-sm-center">
					<h3 class="card-title h5 _desktop-title hidden-md-down">{l s='Quantity' d='Shop.Theme.Checkout'}</h3>
				</div>
				<div class="col-xs-4 text-sm-center text-xs-right">
					<h3 class="card-title h5 _desktop-title hidden-md-down">{l s='Total products' d='Shop.Theme.Checkout'}</h3>
				</div>
            </div>
		</div>
    {/block}
    ...
    {block name='order_confirmation_table'}
        ...
        <div class="order-line row">
          ...
          <div class="col-sm-6 col-xs-12 qty">
            <div class="row">
              ...
              <div class="col-xs-4 text-xs-center">{$product.quantity}</div>
      ...
      <table>
        ...
        {if $subtotals.tax.label !== null}
          <tr class="sub taxes">
            <td><span>{l s='%label%:' sprintf=['%label%' => $subtotals.tax.label] d='Shop.Theme.Global'}</span></td>
