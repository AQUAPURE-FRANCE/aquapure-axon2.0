{if Module::isInstalled('productcomments') && Module::isEnabled('productcomments') && !Context::getContext()->customer->isLogged()}
	<div id="slide-bar-login-comment" class="slide-bar-account slide-bar slide-bar-right" >
		<div class="sb-content">
			<div class="title-top">
				<i class="fto fto-chat product-price"></i>
				<span class="product-price">{l s='Please login first'}</span>
			</div>
