...
{block name='wrapper'}
	<div id="wrapper">
		...
		<div class="container container-parent">
			...
			<section id="main" class="product-layout-8" itemscope itemtype="https://schema.org/Product">
				<meta itemprop="url" content="{$product.url}">
				<div class="row row-product">
					<div id="left-column" class="col-xs-12 col-lg-3 col-product-info">
					...
					<div id="content-wrapper" class="left-column right-column col-xs-12 col-lg-6 col-product-image">
					...
					<div id="right-column" class="col-xs-12 col-lg-3 col-product-info">
