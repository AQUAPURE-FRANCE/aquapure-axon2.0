...
{block name='wrapper'}
	<div id="wrapper">
		...
		<div class="container container-parent">
			...
			<section id="main" class="product-layout-3" itemscope itemtype="https://schema.org/Product">
				<meta itemprop="url" content="{$product.url}">
				<div class="row row-product">
					<div id="content-wrapper" class="right-column col-xs-12 col-lg-8 col-product-image">
						<div id="main-content">
					...
					<div id="right-column" class="col-xs-12 col-lg-4 col-product-info">
